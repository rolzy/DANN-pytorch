...
def train(config):
    ...
    for i in range(config["num_iterations"]):
        ...
        ad_net.train(True)
        transfer_loss = transfer_criterion(features, ad_net, gradient_reverse_layer, iter_num=i, use_gpu=use_gpu)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--t_dset_path', type=str, default='../data/office/webcam_31_list.txt',
